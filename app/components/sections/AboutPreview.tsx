      ...
      <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-2 lg:gap-20">
        ...
        <div>
          ...
          <h2 className="mt-4 text-4xl font-black leading-tight tracking-tight text-[#111827] sm:text-5xl">
            Geelong&apos;s Trusted Painting Specialists Since 2014
          </h2>
          <p className="mt-5 text-base leading-7 text-gray-500 sm:text-lg">
            ...
            workmanship and genuine client care. From a single room refresh to
            a full exterior transformation, every job receives the same careful
            preparation and premium finish.
          </p>
          <p className="mt-4 text-base leading-7 text-gray-500">
            Our experienced team serves residential and commercial clients across
            Geelong, Melbourne, and surrounding suburbs — always delivering
            ...
            {PILLARS.map((p) => (
              <li key={p.title} className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-gray-500">{p.text}</p>
                </div>
              </li>
            ))}
          </ul>
        ...
        <div className="relative grid grid-cols-[1fr_1.15fr] grid-rows-[auto_auto] gap-4">
          ...
          <div className="overflow-hidden rounded-2xl bg-[#0c1f3d] p-6 text-white">
            ...
            <p className="mt-1 text-sm font-semibold">Years serving Geelong &amp; Melbourne</p>
          ...
          <div className="relative col-span-2 overflow-hidden rounded-2xl">
            ...
            <div className="absolute bottom-4 left-4 flex items-center gap-3 rounded-xl bg-white/95 px-4 py-3 shadow-lg backdrop-blur-sm">
              ...
              <div>
                <p className="text-xs font-black text-[#111827]">7-Year Warranty</p>

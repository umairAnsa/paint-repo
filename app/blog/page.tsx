      ...
      <section className="bg-[#f8fafc] px-5 py-16 sm:px-8 sm:py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            <Link href="/contact" className="inline-flex min-h-11 items-center justify-center rounded-full border-2 border-gray-200 px-8 text-sm font-bold text-gray-700 transition hover:border-[#1e3a8a] hover:text-[#1e3a8a]">
              Contact Us
            </Link>
          </div>
        </div>

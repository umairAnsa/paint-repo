...
import { type Invoice, type Lead, INV_STATUS_COLORS, PAGE_SIZE, fmt, fmtPrice } from './types';
...
interface Props {
  ...
  iLeads: Lead[];
  adminKey: string;
  invBusy: Record<string, boolean>;
  onSetInvoiceModal: (lead: Lead) => void;
...
export default function InvoicesTab({
  invoices, iLeads, adminKey, invBusy,
  onSetInvoiceModal, onSendInvoice, onDeleteInvoice, onStatusChange,
}: Props) {

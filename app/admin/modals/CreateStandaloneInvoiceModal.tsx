...
export default function CreateStandaloneInvoiceModal({ adminKey, onClose, onCreated }: Props) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4" onClick={onClose}>
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl" onClick={e => e.stopPropagation()}>
        <div className="mb-5 flex items-center justify-between">
          <h2 className="text-lg font-black text-[#111827]">New Invoice</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          <div className="grid grid-cols-2 gap-3">
            <div className="col-span-2">
              <label className="mb-1 block text-xs font-bold text-gray-500">CLIENT NAME</label>
          ...
          <div className="flex gap-3 pt-1">
            ...
            <button type="submit" disabled={busy}
              className="flex-1 rounded-xl bg-[#f97316] py-3 text-sm font-bold text-white transition hover:bg-[#ea6c07] disabled:opacity-60">

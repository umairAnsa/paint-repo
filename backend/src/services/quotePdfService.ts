...
export function generateQuotePDF(quote: QuoteForPdf): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    ...
    const quoteTotal = quote.price + gstAmount;
    ...
    doc
      ...
      .font("Helvetica-Bold")
      .fillColor(DARK)
      .text("Norm Painting Pty Ltd", ML, y);
    ...
    function metaRow(label: string, value: string, rowY: number) {
      doc
        ...
        .font("Helvetica-Bold")
        .fillColor(GRAY)
        .text(label, rightX, rowY, { width: 90 });
      doc
        .fontSize(8)
        .font("Helvetica")
        .fillColor(DARK)
        .text(value, rightX + 95, rowY, { width: 105, align: "right" });
    }
    ...
    doc
      ...
      .font("Helvetica-Bold")
      .fillColor(WHITE)
      .text(fmtCurrency(quoteTotal), rightX + 10, y + 52, {
        width: 180,
        align: "right",
      });
    ...
    doc
      ...
      .font("Helvetica-Bold")
      .fillColor(GRAY)
      .text("PREPARED FOR", ML, y);
    y += 13;
    doc
      .fontSize(11)
      .font("Helvetica-Bold")
      .fillColor(DARK)
      .text(quote.name, ML, y);
    y += 15;
    doc.fontSize(9).font("Helvetica").fillColor(GRAY).text(quote.email, ML, y);
    y += 13;
    if (quote.phone) {
      doc.text(quote.phone, ML, y);
      y += 13;
    }
    ...
    doc
      ...
      .font("Helvetica-Bold")
      .fillColor(DARK)
      .text(quote.service, COL.service.x + 6, mid, {
        width: COL.service.w - 8,
      });
    doc
      .fontSize(8)
      .font("Helvetica")
    ...
    doc
      .font("Helvetica-Bold")
      .text(fmtCurrency(quote.price), COL.unit.x + 6, mid, {
        width: COL.unit.w - 8,
        align: "right",
      });
    ...
    if (gstAmount > 0) {
      doc
        ...
        .font("Helvetica")
        .fillColor(GRAY)
        .text("Subtotal", totX + 10, y, { width: 90 });
      doc
        .fontSize(8.5)
        .font("Helvetica")
        .fillColor(DARK)
        .text(fmtCurrency(quote.price), totX + 10, y, {
          width: 180,
          align: "right",
        });
      y += 18;
      doc
        ...
        .font("Helvetica")
        .fillColor(GRAY)
        .text(gstLabel, totX + 10, y, { width: 90 });
      doc
        .fontSize(8.5)
        .font("Helvetica")
        .fillColor(DARK)
        .text(fmtCurrency(gstAmount), totX + 10, y, {
          width: 180,
          align: "right",
        });
      y += 24;
    ...
    doc
      ...
      .font("Helvetica-Bold")
      .fillColor(ORANGE)
      .text(fmtCurrency(quoteTotal), totX + 10, y + 8, {
        width: 180,
        align: "right",
      });
    ...
    doc
      ...
      .lineWidth(1)
      .stroke();
    doc.rect(ML, y, 4, 76).fill(ORANGE);
    ...
    doc
      ...
      .fillColor(GRAY)
      .text(
        "Reply to this email or call us on +61 406 342 731 to accept and schedule your job.",
        ML + 16,
        y + 24,
        { width: CW - 24 },
      );
    doc
      ...
      .fillColor(GRAY)
      .text(
        "Payment term: 30% advance payment is required before work begins.",
        ML + 16,
        y + 40,
        { width: CW - 24 },
      );
    doc
      ...
      .fillColor(GRAY)
      .text(
        `This quote is valid until ${fmtDate(quote.validUntil)}. Quote reference: ${quote.quoteNumber}`,
        ML + 16,
        y + 56,
        { width: CW - 24 },
      );
    ...
    doc
      ...
      .font("Helvetica-Bold")
      .fillColor(WHITE)
      .text("Thank you for considering Norm Painting!", 0, footerY + 18, {
        align: "center",
        width: W,
      });
    doc
      ...
      .text(
        "+61 406 342 731  ·  info@normpainting.com  ·  Geelong & Melbourne VIC",
        0,
        footerY + 36,
